...
namespace BIT.XpoExtender.Web
{
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.Web.WebApplication
    public partial class MetadataBuilderAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private BIT.MetadataBuilder.Module.MetadataBuilderModule module3;
        private BIT.MetadataBuilder.Module.Web.MetadataBuilderAspNetModule module4;
        ...
        static MetadataBuilderAspNetApplication() {
        ...
        #endregion
        public MetadataBuilderAspNetApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void MetadataBuilderAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new BIT.MetadataBuilder.Module.MetadataBuilderModule();
            this.module4 = new BIT.MetadataBuilder.Module.Web.MetadataBuilderAspNetModule();
            ...
            // 
            // MetadataBuilderAspNetApplication
            // 
            this.ApplicationName = "BIT.MetadataBuilder";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.MetadataBuilderAspNetApplication_DatabaseVersionMismatch);
